...
class SiswaKelasPolicy
{
    ...
    {
        return $user->can('view_any_siswa::kelas');
    }
    ...
    {
        return $user->can('view_siswa::kelas');
    }
    ...
    {
        return $user->can('create_siswa::kelas');
    }
    ...
    {
        return $user->can('update_siswa::kelas');
    }
    ...
    {
        return $user->can('delete_siswa::kelas');
    }
    ...
    {
        return $user->can('delete_any_siswa::kelas');
    }
